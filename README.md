<p align="center">
  <a href="https://github.com/charlesrajeev">
    <img width="80%" alt="Hello, I'm Charles Rajeev Mundu - Passionate IT Professional" src="./assets/gh-readme-header.png" />
  </a>
</p>
...
- 🎯 Focused on building expertise in **Remote Support**, **Ticketing Systems**, and **Network Diagnostics**  
- ❤️ Passionate about troubleshooting, automation, and helping others through technology  
- 💬 Ask me about anything [here](https://github.com/charlesrajeev/charlesrajeev/issues)  
...
<code><img height="30" alt="freshservice" src="https://assets.website-files.com/5e169b867a9f7a6536f7c4a5/5e1c5dc6b6f7a0b01eea7d36_freshservice.svg"></code>
...
#### Key Activities:  
- Installed and configured remote support tools on my home lab and personal laptop.  
- Practiced:  
  - Connecting to devices remotely.  
  - Transferring files efficiently.  
  - Troubleshooting issues like changing display settings and closing unresponsive applications.  

#### Documentation:  
- [Guide to Setting Up and Using Remote Support Tools](./docs/remote_support_guide.md)  
- Screenshots of live remote sessions and file transfers.  
...
#### Key Activities:  
- Created a free trial account on Zendesk.  
- Simulated common IT support scenarios, including:  
  - Password resets.  
  - Software installation requests.  
  - Troubleshooting slow system performance.  
- Documented troubleshooting steps and resolutions in tickets.  

#### Documentation:  
- [Sample Tickets and Resolutions](./docs/ticket_samples.md)  
- Screenshot walkthroughs of ticket creation, escalation, and closure.  
...
- Analyzed network traffic using Wireshark:  
  - Identified protocols such as HTTP, DNS, and TCP.  
  - Monitored traffic for anomalies and documented findings.  
- Used PingPlotter to visualize network latency and diagnose network issues.  

#### Documentation:  
- [Wireshark Analysis Report](./docs/wireshark_analysis.md)  
- [PingPlotter Diagnostic Report](./docs/pingplotter_report.md)  
- Screenshots of network traffic and latency graphs.  
